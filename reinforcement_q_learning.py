...
Note that this script was adapted from Pytorch's script. I had only substituted lines of code to make them relevant to the ExplodinG Kittens game.
"""
...
def select_action(state):
    ...
    if TESTING or sample>eps_threshold:
        with torch.no_grad():
